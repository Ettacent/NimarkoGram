...
public class RoundVideoSettingsActivity extends BaseFragment {
    ...
    private static final int ROW_CAMERA_TYPE = 1;
    private static final int ROW_ENABLED = 2;
    private static final int ROW_OUTPUT_RESOLUTION = 3;
    private static final int ROW_CAMERA_RESOLUTION = 4;
    private static final int ROW_FRAME_RATE = 5;
    private static final int ROW_BITRATE = 6;
    private static final int ROW_GENERAL_INFO = 7;
    private static final int ROW_COMPOSITION_HEADER = 8;
    private static final int ROW_COMPOSITION = 9;
    private static final int ROW_COMPOSITION_INFO = 10;
    private static final int ROW_COUNT = BuildConfig.DEBUG_PRIVATE_VERSION ? 11 : 8;
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(R.string.RoundVideoSettings) + " · Camera2");
    ...
    private boolean isCameraXSelected() {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            if (position == ROW_CAMERA_TYPE) return true;
            if (position == ROW_ENABLED) {
                return !isCameraXSelected();
            }
            if (!InstantCameraViewBase.isUsingCamera2Implementation()) {
                return false;
            }
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            boolean enabled = InstantCameraViewBase.isUsingCamera2Implementation();
            if (holder.getItemViewType() == TYPE_HEADER) {
                ...
                cell.setEnabled(position == ROW_ENABLED ? !isCameraXSelected() : enabled);
                if (position == ROW_ENABLED) {
                ...
                } else if (position == ROW_OUTPUT_RESOLUTION) {
                    cell.setTextAndValue(
