...
const end = source.indexOf('        if (hadEdit && !st.charStartTimes.isEmpty())', start);
...
public class DeleteParticlesTest {
 ...
 static class State { String prevText; ArrayList<Integer> particles=new ArrayList<>(); }
 static void spawnDeleteParticles(Object edit, State st, int idx, String ch) {
 ...
 static void change(State st,int delCount,int insCount,boolean deleteEnabled) {
  int prefix=0,oldEnd=delCount; Object edit=null;
  st.prevText="a".repeat(delCount);
 ...
 public static void main(String[] args){
  ...
  check(appearanceProgress(100,200,false)>0.9f);
